...
declare module '$env/static/private' {
	...
	export const OPEN_FDA_API_KEY: string;
	...
	export const TAURI_DEV_HOST: string;
	export const TRUNK_SERVE_ADDRESS: string;
